...
----------------------------------------------------------------------------------------------------------------------------------------
select c.cust_name,c.city,c.grade,c.salesman_id,s.city from customer c join salesman s on c.salesman_id=s.salesman_id where c.grade<100;
...
select c.cut,c.name,c.customer_city,c.grade,c.salesman_city from customer c join salesman s on c.salesman_id=s.salesman_id where c.grade<100;
